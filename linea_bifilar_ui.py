...
# Form implementation generated from reading ui file 'linea_bifilar.ui'
#
...
"}")
        ...
        self.lbl_imagen.setGeometry(QtCore.QRect(20, 100, 251, 121))
        self.lbl_imagen.setText("")
        self.lbl_imagen.setPixmap(QtGui.QPixmap("lineabifilar.png"))
...
"}")
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Linea bifilar"))
        ...
        self.lbl_dim1.setToolTip(_translate("Dialog", "<html><head/><body><p>Radio de los conductores.</p></body></html>"))
        self.lbl_dim1.setText(_translate("Dialog", "a:"))
        self.lbl_dim2.setToolTip(_translate("Dialog", "<html><head/><body><p>Separación entre los conductores.</p></body></html>"))
        self.lbl_dim2.setText(_translate("Dialog", "d:"))
