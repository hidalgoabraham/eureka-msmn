...
from ventana_linea_ui import Ui_MainWindow as VentanaLinea
...
class ControladorDeLinea(QMainWindow,VentanaLinea):
    ...
    def salir(self): 
        self.hide()
        self.cvp.pbtn_configurar_linea.setEnabled(True)
    ...
    def accion_perdidas(self): 
        ...
        if self.cbx_perdidaslinea.currentText()=='Sin pérdidas':
            ...
            self.lbl_modolinea.hide()
            self.cbx_modolinea.hide()
            self.cvp.lbl_vswr.show()
            self.cvp.linedit_vswr.show()
                                       
        elif self.cbx_perdidaslinea.currentText()=='Pérdidas generales':
            self.cbx_tipocoero.hide()
            self.lbl_modolinea.show()
            self.cbx_modolinea.show()
            self.cvp.lbl_vswr.hide()
            self.cvp.linedit_vswr.hide()
    ...
    def bloquear(self):
        self.cvp.pbtn_configurar_linea.setEnabled(False)
        self.hide()
