...
# Form implementation generated from reading ui file 'linea_coaxial.ui'
#
...
"}")
        ...
        self.lbl_imagen.setGeometry(QtCore.QRect(20, 80, 251, 141))
        self.lbl_imagen.setText("")
        self.lbl_imagen.setPixmap(QtGui.QPixmap("lineacoaxial.png"))
...
"}")
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Linea coaxial"))
        ...
        self.lbl_dim1.setToolTip(_translate("Dialog", "<html><head/><body><p>Radio del conductor interno.</p></body></html>"))
        ...
        self.lbl_dim2.setToolTip(_translate("Dialog", "<html><head/><body><p>Radio del conductor externo.</p></body></html>"))
        self.lbl_dim2.setText(_translate("Dialog", "b:"))
